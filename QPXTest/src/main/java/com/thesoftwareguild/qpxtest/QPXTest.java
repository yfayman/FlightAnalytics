 ...
 */
package com.thesoftwareguild.qpxtest;
...
public class QPXTest {
    ...
    private static final String APPLICATION_NAME = "FlightMaster";

    private static final String API_KEY = "AIzaSyCBGr_EjQy3weyXzv23hg05cff6T4B7nD4";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            slice.setOrigin("NYC");
            slice.setDestination("ORD");
            slice.setDate("2015-10-31");
            slices.add(slice);
            
            TripOptionsRequest request = new TripOptionsRequest();
            request.setSolutions(10); // number of flights to return
